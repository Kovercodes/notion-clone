...
export const Navigation = () => {
    ...
    return (
        <>
            ...
            >
                <div className={cn(
                    "h-6 w-6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neurtal-600 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition",
                ...
                <div>
                    <UserItem/>
                    <Item label="Find" icon={Search} isSearch onClick={search.onOpen}/>
